...
@Autonomous(name = "AutoEncoderPushbot")
public class AutoEncoderPushbot extends LinearOpMode {
    ...
    static final double COUNTS_PER_INCH = (TICKS_PER_REV * GEAR_RATIO) / (Math.PI * WHEEL_DIAMETER_INCHES);
    ...
    private void driveForward(double inches) {
        driveInches(0.6, inches, inches, inches, inches);
    }
